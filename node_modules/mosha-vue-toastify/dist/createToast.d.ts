...
import { Position, ToastObject, ToastOptions, ToastContent, DisplayContentObject } from './types';
export declare const createToast: (content: ToastContent, options?: ToastOptions | undefined) => void;
export declare const setupVNode: (options: ToastOptions, content: DisplayContentObject | Component) => void;
